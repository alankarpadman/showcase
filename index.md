...
## 2. Flight Data Analysis				   (R, Rstudio, Weka, R Shiny API)			                    UNC-Charlotte
...
## 3. Signup Conversion Prediction		    (Python- Pandas, Numpy, Matplotlib, Scikit-Learn)		             Personal
...
## 4. Auto Order Replenishment	        (Excel, Power BI, Data Mining Add-in for Excel, SSAS)   			      ATD
...
## 5. Movie Data Analytics                   (Hadoop, R, Java, Excel, SPSS, SAS, Tableau)	 	                UNC-Charlotte
...
## 6. Anaplan Upload				(SSIS, C#, Batch Scripts, Postman, Anaplan)				      ATD
...
## 7. Statistical Analysis in SAS			(SAS Enterprise Guide, SAS eMiner)		                UNC-Charlotte            
